        ...
        var r = e.DataTable({
            ...
            columnDefs: [{
                ...
                render: function(e, a, t, s) {
                    ...
                    return '<div class="d-flex justify-content-left align-items-center"><div class="avatar ' + ("" === l ? " bg-light-" + i + " " : "") + ' me-1">' + d + '</div><div class="d-flex flex-column"><span class="emp_name text-truncate fw-bold">' + r + '</span><small class="emp_post text-truncate text-muted">' + n + "</small></div></div>"
                }
            }, {
        ...
        var d = s.DataTable({
            ...
            drawCallback: function(e) {
                ...
                a.column(2, {
                    ...
                    s !== e && ($(t).eq(a).before('<tr class="group"><td colspan="8">' + e + "</td></tr>"), s = e)
                }))
            },
            responsive: {
                details: {
